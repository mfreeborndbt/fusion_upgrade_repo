{{
  config(
    materialized='table',
    description='Historical order data that would use Iceberg table format in production - Fusion blocker'
  )
}}

-- This model uses Iceberg table materialization which creates a Fusion migration blocker
