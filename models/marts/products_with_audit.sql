{{
  config(
    materialized='table',
    description='Products model that would use custom audit_table materialization in production - Fusion blocker'
  )
}}

-- This model uses a custom materialization which creates a Fusion migration blocker
